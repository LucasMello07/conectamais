...
import conecta.service.CadastroProfissionalService;
...
public class CadastroProfissionalServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        cadastroProfissionalService = new CadastroProfissionalService();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        usuario.setCpfCnpj(request.getParameter("cpfCnpj")); // no form do profissional pode estar assim mesmo
        ...
        try {
            cadastroProfissionalService.cadastrarProfissional(usuario);
            request.setAttribute("sucesso", "Cadastro de profissional realizado com sucesso! Faça login.");
